...
tellraw @a [{"type":"translatable","translate":"redstone.show.entity.dfl.entity.item","fallback":"掉落物数量：","color":"yellow"},{"score":{"name":"item","objective":"dfl_scoreboard"},"color":"red"}]
