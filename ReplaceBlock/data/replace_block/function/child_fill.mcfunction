...
execute store result score fill_falling_block rb.temp run data get storage replace_block:data settings.fill_falling_block
# 主世界
...
# 主世界 - 处理沙子、红沙、沙砾
    $execute if dimension minecraft:overworld \
        if score fill_falling_block rb.temp matches 1 \
