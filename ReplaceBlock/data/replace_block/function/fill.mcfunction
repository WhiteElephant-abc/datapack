...
# 执行fill
function replace_block:child_fill with storage replace_block:data temp.run_fill

# 读取settings.success_num
execute store result score success_num temp.fill run data get storage replace_block:data settings.success_num
