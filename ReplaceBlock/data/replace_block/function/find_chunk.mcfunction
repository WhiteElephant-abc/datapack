...
scoreboard players operation chunk_x find_chunk *= c16 find_chunk
scoreboard players operation chunk_z find_chunk *= c16 find_chunk
execute store result storage replace_block:data temp.find_chunk.a_x int 1 run scoreboard players get chunk_x find_chunk
execute store result storage replace_block:data temp.find_chunk.a_z int 1 run scoreboard players get chunk_z find_chunk
scoreboard players add chunk_x find_chunk 15
scoreboard players add chunk_z find_chunk 15
execute store result storage replace_block:data temp.find_chunk.b_x int 1 run scoreboard players get chunk_x find_chunk
execute store result storage replace_block:data temp.find_chunk.b_z int 1 run scoreboard players get chunk_z find_chunk
